...
class CactusSyncInitI<TCacheShape> extends CactusSyncI {
 ...
 */
type HandleModelChange<TIDatabaseChange extends IDatabaseChange> = ({
  change,
}: {
...
const useRunHooks = <TIDatabaseChange extends IDatabaseChange>({
 ...
 class ModelReplicationI extends ModelNameReplicationI {
  queries: string[]
}
 type ModelNameReplicationI = {
 ...
 * */
class CactusSync<TCacheShape = any> extends Dexie {
  /**
